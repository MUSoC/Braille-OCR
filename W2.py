...
r,c,w=th2.shape
horizontalStructure = cv2.getStructuringElement(cv2.MORPH_RECT, (c+200,7))
...
for i in range (0,len(lines)):
    if i!=len(lines)-1:
        ...
        p.append(th2[sorted_m[len(lines)][0][1]:r, sorted_m[len(lines)][0][0]:sorted_m[len(lines)][1][0]])
